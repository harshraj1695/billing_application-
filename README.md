...
- For thermal-printer support, install and configure CUPS so the `lp` command is
  available. The application sends ESC/POS data to the default CUPS printer.
- Barcode stickers open in the default browser; use its print dialog to print
  them.
